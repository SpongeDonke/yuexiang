        ...
        <div class="modal-content" @click.stop>
          ...
          <div class="modal-body">
            ...
            <div v-else-if="orderDetail" class="detail-grid">
              ...
              <div class="detail-item">
                <label><i class="fas fa-store"></i> 店铺</label>
                <span>{{ orderDetail.shopName || '未知店铺' }}</span>
              </div>
...
.stat-card.total i { color: #dc3545; }
...
.btn-outline:hover { border-color: #dc3545; color: #dc3545; }

.loading-container {
  text-align: center;
  padding: 60px;
}
.loading-spinner { font-size: 48px; color: #dc3545; }
...
.btn-icon.view { background: #fff1f0; color: #dc3545; }
.btn-icon.view:hover { background: #dc3545; color: white; }
...
.detail-item.highlight { background: #fff1f0; border-left-color: #dc3545; }
.detail-item.amount { background: #fffbe6; border-left-color: #fa8c16; }
