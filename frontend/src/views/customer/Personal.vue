      ...
      <div class="profile-header">
        <div class="avatar-section">
          ...
          <div class="user-badge" :class="'role-' + user.roleId">
            <i :class="getRoleIcon(user.roleId)"></i>
            <span>{{ getRoleName(user.roleId) }}</span>
          </div>
        </div>
        <h1 class="profile-title">个人中心</h1>
        <p class="welcome-text">管理您的个人信息</p>
      </div>
...
const getRoleIcon = (roleId) => {
  switch (roleId) {
    case 1: return 'fas fa-store'
    case 2: return 'fas fa-shield-alt'
    case 3: return 'fas fa-user'
...
.btn-save:hover {
  ...
  box-shadow: 0 6px 22px rgba(56, 239, 125, 0.45);
}
